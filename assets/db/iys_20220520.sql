...
--
-- Host: localhost
-- Generation Time: May 20, 2022 at 10:39 AM
...
INSERT INTO `payment_types` (`id_payment_type`, `id_summit`, `start_date`, `end_date`, `amount`, `description`) VALUES
(4, 1, '2022-05-17 05:00:00', '2022-05-22 05:00:00', 2500000, 'Registration'),
(5, 1, '2022-07-12 05:00:00', '2022-05-26 05:00:00', 3000000, 'Batch 1');
...
--
ALTER TABLE `payment_types`
  MODIFY `id_payment_type` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
