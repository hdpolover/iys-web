...
INSERT INTO `ambassador` (`id_ambassador`, `name`, `referral_code`, `total_redeem`, `photo`) VALUES
(3, 'Ilham Sagita Pratama', 'AMB23ISPRJ', 0, 'http://127.0.0.1/iys-web/uploads/ambassador/851333edec004b6addcb126ece5588a3.jpg');
...
(248, 'AX', 'ALA', 'ÃƒÆ’Ã¢â‚¬Â¦land Islands', 'ÃƒÆ’Ã¢â‚¬Â¦land Island'),
...
(384, 'CI', 'CIV', 'CÃƒÆ’Ã‚Â´te d\'Ivoire', 'Ivorian'),
...
(492, 'MC', 'MCO', 'Monaco', 'MonÃƒÆ’Ã‚Â©gasque, Monacan'),
...
(531, 'CW', 'CUW', 'CuraÃƒÆ’Ã‚Â§ao', 'CuraÃƒÆ’Ã‚Â§aoan'),
...
(638, 'RE', 'REU', 'RÃƒÆ’Ã‚Â©union', 'RÃƒÆ’Ã‚Â©unionese, RÃƒÆ’Ã‚Â©unionnais'),
(642, 'RO', 'ROU', 'Romania', 'Romanian'),
(643, 'RU', 'RUS', 'Russian Federation', 'Russian'),
(646, 'RW', 'RWA', 'Rwanda', 'Rwandan'),
(652, 'BL', 'BLM', 'Saint BarthÃƒÆ’Ã‚Â©lemy', 'BarthÃƒÆ’Ã‚Â©lemois'),
...
(678, 'ST', 'STP', 'Sao Tome and Principe', 'SÃƒÆ’Ã‚Â£o TomÃƒÆ’Ã‚Â©an'),
...
(854, 'BF', 'BFA', 'Burkina Faso', 'BurkinabÃƒÆ’Ã‚Â©'),
...
('USRP_d5dd8f50', 1, 1, '2022-01-20', 5, 'Ilham Supali', 'Bangladesh', 'sf', 'asdf', 'sdaf', '08966786546', 'sdf', 'sadf', 'sadf', 'sadf', 'XL', 1, 'sdf', 'asef', 'gfdsg', 'dsaf', 'asdf', 'Theme2', 'sdafawe', 'Friends', 'sdf', 'sdf', 'sef', 'sdf', 1, 1, 'http://127.0.0.1/iys-web/uploads/self-photo/9c348b300dfce46dbca5a9c5ffe0555f.jpg', 3, NULL),
...
(1, 'Istanbul Youth Summith 2022', 'Inspiring', '2022-07-02 17:00:00', '2023-01-01 16:59:59', NULL, NULL);
...
--
ALTER TABLE `ambassador`
  MODIFY `id_ambassador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
