...
CREATE TABLE `payment_status` (
  ...
  `id_user` varchar(100) DEFAULT NULL,
  `status` tinyint(4) DEFAULT 0 COMMENT '0: waiting; 1: purchase; 2: pending: 3; failure: 4; purchased',
...
INSERT INTO `payment_status` (`id_payment_status`, `id_payment_type`, `id_user`, `status`, `proof_of_payment`) VALUES
(8, 8, 'USRP_f283c819', 0, NULL),
(9, 9, 'USRP_f283c819', 0, NULL),
(10, 10, 'USRP_f283c819', 0, NULL);
...
INSERT INTO `payment_transaction` (`id_payment_transaction`, `id_user`, `id_payment_type`, `total`, `order_id`, `date`, `date_expired`, `method`, `item`, `status`) VALUES
('TRANSe7b5d3a003c8be1193006e890174014d', 'USRP_f283c819', NULL, 1500000, '35995344', NULL, NULL, 'bank_transfer', NULL, NULL);
...
--
ALTER TABLE `payment_status`
  MODIFY `id_payment_status` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
