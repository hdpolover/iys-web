...
<body style="background: #f2f2f2;padding-top: 50px;padding-bottom: 50px;padding-left: 50px;padding-right: 50px;">
    <div class="card">
        <div class="card-body">
            ...
            <p class="mb-4">Please click the button below to change your password.</p>
            <?php
                $token_forgot = str_replace('/', '_', $token_forgot);
                $token_forgot = str_replace('+', '-', $token_forgot);
            ?>  
            <a href="<?= site_url('forgot-password/change-password/'.$token_forgot)?>" class="btn btn-soft-primary mb-6">Change Password</a>
        </div>
    </div>
</body>
</html>