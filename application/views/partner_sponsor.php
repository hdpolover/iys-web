...
<div class="pt-4 ">
    <div class="container d-flex align-items-center vh-100 mt-5">
        <div class="mt-3" style="height: 500px;width: 100%; padding-top: 56.2500%;
            padding-bottom: 48px; box-shadow: 0 2px 8px 0 rgba(63,69,81,0.16); margin-top: 1.6em; margin-bottom: 0.9em; overflow: hidden;
            border-radius: 8px; will-change: transform;">
            <iframe loading="lazy" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; border: none; padding: 0;margin: 0;"
                    src="https:&#x2F;&#x2F;www.canva.com&#x2F;design&#x2F;DAE-rUgAfHA&#x2F;view?embed" allowfullscreen="allowfullscreen" allow="fullscreen">
            </iframe>
        </div>
    </div>
    ...
    <div class="row justify-content-center text-center mt-5 mb-5 px-5">
      <div class="col-3 col-sm-3 col-md-2 py-3" style="display: flex;justify-content: center;align-items: center;">
        <img class="w-100" src="<?= site_url('assets/img/partnership/times.png')?>" alt="Logo">
      </div>
      <!-- End Col -->
