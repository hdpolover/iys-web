          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div id="boxStatus" class="text-center mt-4 mb-4">
                  <?php
                    if($paymentDetail->status == '2'){
                      echo '
                        <button type="button" class="btn btn-warning">WAITING APPROVAL</button>    
                      ';
              ...
              <dl class="row mt-4 mb-4">
                  ...
                  <dd class="col-sm-6 text-sm-end mb-0"><button onclick="mdlEvidence()" class="btn btn-sm btn-soft-success">Show</button></dd>
              </dl>
              <dl class="row mt-4 mb-4">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <form action="<?= site_url('payment/manual-cancel')?>" method="POST">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div id="boxImg" class="text-center mb-3 p-3" style="border: .0625rem solid rgba(33,50,91,.1);border-radius: .3125rem;cursor: pointer;">
                <img style="max-width: 300px;" id="blah" class="" src="<?= $paymentDetail->evidence?>" />
            </div>
          </div>
