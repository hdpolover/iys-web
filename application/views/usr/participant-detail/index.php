                ...
                <div id="validationFormContent">
                  <div id="validationFormBasic" class="active">
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="js-form-message">
                          <input type="text" class="form-control flatpickr" name="birthday" placeholder="Birthday" required>
                          ...
                          <div class="row">
                            <div class="col-sm mb-2 mb-sm-0">
                              ...
                              <label class="form-control" for="formControlRadioEg1">
                                <span class="form-check">
                                  <input type="radio" class="form-check-input" name="gender" value="1" id="formControlRadioEg1" required>
                            ...
                            <div class="col-sm mb-2 mb-sm-0">
                              ...
                              <label class="form-control" for="formControlRadioEg2">
                                <span class="form-check">
                                  <input type="radio" class="form-check-input" name="gender" value="2" id="formControlRadioEg2" required>
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="js-form-message">
                          <input type="text" class="form-control" name="occupation" id="validationFormUsernameLabel" placeholder="Occupation" aria-label="Username" required data-msg="Please enter your fullname.">
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="js-form-message input-group">
                          ...
                          <input type="text" class="form-control" onkeypress="return space(event)" name="instagram" id="validationFormUsernameLabel" placeholder="Instagram Account" aria-label="Username" required data-msg="Please enter your fullname.">
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="js-form-message">
                          <input type="text" class="form-control" name="emergency" id="validationFormUsernameLabel" placeholder="Emergency Contact" aria-label="Username" required data-msg="Please enter your fullname.">
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="js-form-message">
                          <textarea  class="form-control" name="disease" required rows="5"></textarea>
                  ...
                  <div id="validationFormOther" style="display: none;">
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="js-form-message">
                          <textarea  class="form-control" name="experience" required rows="5"></textarea>
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="js-form-message">
                          <textarea  class="form-control" name="achievements" required rows="5"></textarea>
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="js-form-message">
                          <textarea  class="form-control" name="socialProjects" required rows="5"></textarea>
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="js-form-message">
                          <textarea  class="form-control" name="talents" required rows="5"></textarea>
                  ...
                  <div id="validationFormProgram" style="display: none;">
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="js-form-message">
                          <input type="text" class="form-control" name="sourceAccount" id="validationFormUsernameLabel" placeholder="Source Account / Name" aria-label="sourceAccount" required data-msg="Please enter your fullname.">
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="js-form-message">
                          <input type="text" class="form-control" name="motivation" id="validationFormUsernameLabel" placeholder="Motivation Video Link" aria-label="sourceAccount" required data-msg="Please enter your fullname.">
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="js-form-message">
                          <input type="text" class="form-control" name="shareRequirement" id="validationFormUsernameLabel" placeholder="Share Requirement Proof Link" aria-label="sourceAccount" required data-msg="Please enter your fullname.">
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-9">
                        <div class="js-form-message input-group">
                          <input type="text" class="form-control" name="referral" id="validationFormUsernameLabel" placeholder="Referral Code" aria-label="sourceAccount" required data-msg="Please enter your fullname.">
