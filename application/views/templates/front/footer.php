      ...
      <div class="row mb-7">
        ...
        <div class="col-sm-auto">
          ...
          <ul class="list-inline mb-0">
            <li class="list-inline-item">
              <a class="btn btn-soft-light btn-sm btn-icon" href="mailto:info@istanbulyouthsummit.com" target="_blank">
                <i class="bi-google"></i>
              </a>
            </li>
          
            <li class="list-inline-item">
              <a class="btn btn-soft-light btn-sm btn-icon" href="https://instagram.com/istanbulyouthsummit" target="_blank">
                <i class="bi-instagram"></i>
              </a>
            </li>
            <li class="list-inline-item">
              <a class="btn btn-soft-light btn-sm btn-icon" href="https://www.facebook.com/Istanbulyouthsummit/" target="_blank">
                <i class="bi-facebook"></i>
              </a>
            </li>
            <li class="list-inline-item">
              <a class="btn btn-soft-light btn-sm btn-icon" href="https://www.tiktok.com/@istanbulyouthsummit" target="_blank">
            ...
            <li class="list-inline-item">
              <a class="btn btn-soft-light btn-sm btn-icon" href="https://www.youtube.com/channel/UCC5bEuG6JmV_ZPw5p-WzH7g" target="_blank">
  ...
  <!-- ========== END SECONDARY CONTENTS ========== -->
  <a href="https://wa.me/6285172201727" target="_blank" class="float pt-2 ps-0">
  ...
  <script>
    (function() {
      ...
      // =======================================================
      const oneYearFromNow = new Date('September 01, 2022 12:00:00')
