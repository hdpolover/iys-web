  ...
  <main id="content" role="main">
    ...
    <div class="container content-space-3 content-space-t-lg-4 content-space-b-lg-3">
      <div class="flex-grow-1 mx-auto" style="max-width: 28rem;">
        ...
        <!-- Form -->
        <form class="js-validate needs-validation" action="<?= site_url('affiliate/login')?>" method="POST" novalidate>
          <!-- Form -->
          <div class="mb-4">
            <label class="form-label" for="signupSimpleLoginEmail">Affiliate Code</label>
            <input type="text" class="form-control form-control-lg" name="referral" id="signupSimpleLoginEmail" placeholder="" aria-label="email@site.com" required>
            <span class="invalid-feedback">Please enter a affiliate code.</span>
          </div>
          <!-- End Form -->
