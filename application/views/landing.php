<body>
            ...
            <ul class="navbar-nav">
                      ...
                      <div class="navbar-dropdown-menu-inner">
                        <div class="row">
                          <div class="col-sm mb-3 mb-sm-0">
                            ...
                            <a class="dropdown-item active" href="<?= site_url()?>landing-classic-business.html">Business</a>
                          </div>
                          <!-- End Col -->
              ...
              <li class="hs-has-sub-menu nav-item">
                ...
                <div class="hs-sub-menu dropdown-menu" aria-labelledby="accountMegaMenu" style="min-width: 14rem;">
                  ...
                  <a class="dropdown-item " href="<?= site_url()?>account-overview.html">Personal Info</a>
  ...
  <main id="content" role="main">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 mb-4 mb-lg-0">
          <!-- Card -->
          <a class="card card-transition align-items-end flex-wrap flex-row bg-img-start h-100" href="#" style="background-image: url(<?= site_url()?>assets/svg/components/card-4.svg); min-height: 25rem;" data-aos="fade-up">
            <div class="card-body">
        ...
        <div class="col-sm-6 col-lg-3 mb-4 mb-sm-0">
          <!-- Card -->
          <a class="card card-transition align-items-end flex-wrap flex-row bg-img-start h-100" href="#" style="background-image: url(<?= site_url()?>assets/svg/components/card-5.svg); min-height: 25rem;" data-aos="fade-up" data-aos-delay="100">
            <div class="card-body">
        ...
        <div class="col-sm-6 col-lg-3">
          <!-- Card -->
          <a class="card card-transition align-items-end flex-wrap flex-row bg-img-start h-100" href="#" style="background-image: url(<?= site_url()?>assets/svg/components/card-6.svg); min-height: 25rem;" data-aos="fade-up" data-aos-delay="150">
            <div class="card-body">
    ...
    <div class="container content-space-2 content-space-b-lg-3">
      ...
      <div class="js-swiper-clients swiper text-center">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <img class="avatar avatar-lg avatar-4x3" src="<?= site_url()?>assets/svg/brands/fitbit-dark.svg" alt="Logo">
          </div>
          <!-- End Slide -->

          <div class="swiper-slide">
            <img class="avatar avatar-lg avatar-4x3" src="<?= site_url()?>assets/svg/brands/forbes-dark.svg" alt="Logo">
          </div>
          <!-- End Slide -->

          <div class="swiper-slide">
            <img class="avatar avatar-lg avatar-4x3" src="<?= site_url()?>assets/svg/brands/mailchimp-dark.svg" alt="Logo">
          </div>
          <!-- End Slide -->

          <div class="swiper-slide">
            <img class="avatar avatar-lg avatar-4x3" src="<?= site_url()?>assets/svg/brands/layar-dark.svg" alt="Logo">
          </div>
          <!-- End Slide -->

          <div class="swiper-slide">
            <img class="avatar avatar-lg avatar-4x3" src="<?= site_url()?>assets/svg/brands/hubspot-dark.svg" alt="Logo">
          </div>
          <!-- End Slide -->
        </div>
      </div>
    ...
    <!-- Card Grid -->
    <div class="bg-dark rounded-2 mx-3 mx-xl-10" style="background-image: url(<?= site_url()?>assets/svg/components/wave-pattern-light.svg);">
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                ...
                <div class="card h-100">
                  <img class="card-img-top" src="<?= site_url()?>assets/img/480x320/img7.jpg" alt="Image Description">

                  <div class="card-body">
                    <div class="mb-3">
                      <img class="avatar avatar-lg avatar-4x3" src="<?= site_url()?>assets/svg/brands/airbnb-dark.svg" alt="Logo">
                    </div>
                  ...
                  <div class="card-footer pt-0">
                    <a class="card-link" href="<?= site_url()?>page-customer-story.html">Read story <i class="bi-chevron-right small ms-1"></i></a>
                  </div>
                </div>
                <!-- End Card -->
              </div>
              ...
              <div class="swiper-slide">
                <!-- Card -->
                <div class="card h-100">
                  <img class="card-img-top" src="<?= site_url()?>assets/img/480x320/img6.jpg" alt="Image Description">

                  <div class="card-body">
                    <div class="mb-3">
                      <img class="avatar avatar-lg avatar-4x3" src="<?= site_url()?>assets/svg/brands/shopify-dark.svg" alt="Logo">
                    </div>
                    <p class="card-text">Front Projects has proved to be most efficient cloud based project tracking and bug tracking tool.</p>
                  </div>
              ...
              <div class="swiper-slide">
                <!-- Card -->
                <div class="card h-100">
                  <img class="card-img-top" src="<?= site_url()?>assets/img/480x320/img14.jpg" alt="Image Description">
              ...
              <div class="swiper-slide">
                <!-- Card -->
                <div class="card h-100">
                  <img class="card-img-top" src="<?= site_url()?>assets/img/480x320/img12.jpg" alt="Image Description">

                  <div class="card-body">
                    <div class="mb-3">
                      <img class="avatar avatar-lg avatar-4x3" src="<?= site_url()?>assets/svg/brands/capsule-dark.svg" alt="Logo">
                    </div>
              ...
              <div class="swiper-slide">
                <!-- Card -->
                <div class="card h-100">
                  <img class="card-img-top" src="<?= site_url()?>assets/img/480x320/img27.jpg" alt="Image Description">
  ...
  <div class="container position-fixed bottom-0 start-0 end-0 zi-3">
    <div class="alert alert-white w-lg-75 shadow-sm mx-auto" role="alert">
      ...
      <p class="small"><span class="fw-semi-bold">Note!</span> This is just a simple popup modal to demonstrate how you can display a cookie message. This website uses the following types of cookies; strictly necessary, functional, visitor statistics and advertising cookies.</p>
