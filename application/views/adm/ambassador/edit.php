    ...
    <div class="navbar-sidebar-aside-content content-space-1 content-space-md-2 px-lg-5 px-xl-10">
      ...
      <!-- Transaction Table -->
        ...
        <div class="row mt-3">
            ...
            ?>
          <form action="<?= site_url('admin/ambassador/change')?>" method="POST" enctype="multipart/form-data">
            <div class="row">
              <div class="col">
                <div class="mb-3">
                    <label for="validationValidInput1">Name</label>
                    <input type="text" name="name" class="form-control" value="<?= $ambassador->name ?>" id="validationValidInput1" placeholder="Placeholder" required>
                </div>
              </div>
              <div class="col">
                <div class="mb-3">
              ...
              <div class="mb-3">
                  ...
                  <div id="boxImg" class="text-center mb-3 p-3" style="border: .0625rem solid rgba(33,50,91,.1);border-radius: .3125rem;cursor: pointer;">
                      <img style="max-width: 300px;" id="blah" class="" src="<?= $ambassador->photo ?>" />
                  </div>
            ...
            <div style="float: right;">
                ...
                <input type="hidden" name="id" value="<?= $ambassador->id_ambassador?>">
