    ...
    <div class="navbar-sidebar-aside-content content-space-1 content-space-md-2 px-lg-5 px-xl-10">
      ...
      <div class="docs-page-header">
        <div class="row align-items-center">
          <div class="col-sm">
            <h1 class="docs-page-header-title">Add New Announcement</h1>
          </div>
        </div>
      </div>
      <!-- End Page Header -->
      <!-- Transaction Table -->
        ...
        <div class="row mt-3">
            ...
            ?>
          <form action="<?= site_url('admin/announcement-registered/store')?>" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
